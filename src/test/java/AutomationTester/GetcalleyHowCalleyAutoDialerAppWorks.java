...
public class GetcalleyHowCalleyAutoDialerAppWorks {
    ...
    public static void captureScreenshot(String browser, String deviceType, Dimension resolution) {
        ...
        String fileName = "GetcalleyHowCalleyAutoDialerAppWorks_" + browser + "_" + deviceType + "_" + resolutionString + "_" + dateFile + ".png";
